                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                            Pemasukan</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. {{ number_format($data->total_pemasukan, 2, ",", ".") }}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. {{ number_format($data->total_perbulan, 2, ",", ".") }}</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                            Pesanan Pending</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $keranjang->total_pending }}</div>
                    </div>
                    <div class="col-auto">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mt-4 text-center small">
                    <span class="mr-2">
                        <i class="fas fa-circle text-primary"></i> Pesanan Selesai
                    </span>
                    <span class="mr-2">
                        <i class="fas fa-circle text-success"></i> Pesanan Pending
                    </span>
                </div>
            </div>
        </div>
...
$(document).ready( function () {
    var table = $('#table-menu').DataTable({
        ...
        columns     : [
            ...
            {data   : 'detail_pesanan', name: 'detail_pesanan', render: function(data){
                let result = "<ul>";
                data = JSON.parse(data);
                for (let i = 0; i < data.length; i++) {
                    const item = data[i];
                    result += `<li>${item.nama_menu} | ${item.quantity} porsi | Rp. ${item.total_harga}</li>`
                }
                result += "</ul>";
                return result;
            }},
